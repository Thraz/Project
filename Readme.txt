To run a Hunt for my system, call the hunt method. An exemple is uncluded in the hunt script.
To run the example navigate to the scripts containing folder in a terminal and use the command:
python hunt.py
